...
import org.gec.smart.bean.Student;
...
public class GetStudentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        //根据参数执行查询
        List<Student> students = findStudents(name, number);
        //把List集合转换成JSON格式字符串
     ...
     * @return
     */
    private List<Student> findStudents(String name, String number) {
        ...
        try {
            ...
            System.out.println("学生查询数据库连接获取成功，开始查询");
            ...
            while (rs.next()) {
                ...
                list.add(new Student(id, nam, num, rfid, status));
            }
            return list;
        }
